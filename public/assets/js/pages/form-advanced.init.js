!function (t) {
    ...
    a.prototype.init = function () {
        t(".select2").select2(), t(".select2-limiting").select2({maximumSelectionLength: 2}), t(".colorpicker-default").colorpicker({format: "hex"}), t(".colorpicker-rgba").colorpicker(), t("#colorpicker-horizontal").colorpicker({
            color: "#88cc33",
            horizontal: !0
